...
namespace DataTypes {
  ...
  bool getInstructionSupported(ProcessorVersion processorVersion, uint8_t opCode);
  QString getInstructionMnemonic(ProcessorVersion processorVersion, uint8_t opCode);

  static const QList<Instruction> M6800InstructionPage = {{INVALID, 0},
                                                          {INH, 2},
                                                          {INVALID, 0},
                                                          {INVALID, 0},
                                                          {INVALID, 0},
                                                          ...
                                                          {EXT, 5},
                                                          {EXT, 6}};
  static const QList<Instruction> M6803InstructionPage = {{INVALID, 0},
                                                          {INH, 2},
                                                          {INVALID, 0},
                                                          {INVALID, 0},
                                                          {INH, 3},
  ...
  static const QMap<QString, MnemonicInfo> mnemonics = {
    ...
    {"ANDA",
     {{0, 0x84, 0x94, 0xA4, 0xB4, 0},
      "--**0-",
      "ACCA <- ACCA · M",
      "Performs logical 'AND' between the contents of ACCA and the contents of M and places the result in ACCA. (Each bit of ACCA after the operation will be the logical 'AND' of "
      "the corresponding bits of M and of ACCA before the operation.)",
      M6800 | M6803}},
    {"ANDB",
     {{0, 0xC4, 0xD4, 0xE4, 0xF4, 0},
      "--**0-",
      "ACCB <- ACCB · M",
      "Performs logical 'AND' between the contents of ACCB and the contents of M and places the result in ACCB. (Each bit of ACCB after the operation will be the logical 'AND' of "
      "the corresponding bits of M and of ACCB before the operation.)",
      M6800 | M6803}},
    ...
    {"BCC", {{0, 0, 0, 0, 0, 0x24}, "------", "Branch if carry clear - C=0", "Tests the state of the C bit and causes a branch if C is clear.", M6800 | M6803}},
    {"BCS", {{0, 0, 0, 0, 0, 0x25}, "------", "Branch if carry set - C=1", "Tests the state of the C bit and causes a branch if C is set.", M6800 | M6803}},
    {"BEQ", {{0, 0, 0, 0, 0, 0x27}, "------", "Branch if equal - Z=1", "Tests the state of the Z bit and causes a branch if the Z bit is set.", M6800 | M6803}},
    {"BGE",
     {{0, 0, 0, 0, 0, 0x2C},
      "------",
      "Branch if greater than or equal to zero - N=V",
      "Causes a branch if (N is set and V is set) OR (N is clear and V is clear). If the BGE instruction is .executed immediately after execution of any of the instructions CBA, "
      "CMP, SBA, or SUB, the branch will occur if and only if the two's complement number represented by the minuend (Le. "
      "ACCX) was greater than or equal to the two's complement number represented by the subtrahend (Le. M).",
      M6800 | M6803}},
    {"BGT",
     {{0, 0, 0, 0, 0, 0x2E},
      "------",
      "Branch if greater than zero - Z=1 and N=V",
      "Causes a branch if [Z is clear] AND [(N is set and V is set) OR (N is clear and V is clear)]. If the BGT instruction is executed immediately after execution of any of the "
      "instructions CBA, CMP, SBA, or SUB, the branch will occur if and only if the two's complement number represented by "
      "the minuend (Le. ACCX) was greater than the two's complement number represented by the subtrahend (Le. M).",
      M6800 | M6803}},
    {"BHI",
     {{0, 0, 0, 0, 0, 0x22},
      "------",
      "Branch if higher - C=0 and Z=0",
      "Causes a branch if (C is clear) AND (Z is clear). If the BHI instruction is executed immediately after execution of any of the instructions CBA, CMP, SBA, or SUB, the "
      "branch will occur if and only if the unsigned binary number represented by the minuend (Le. ACCX) was greater than the "
      "unsigned binary number represented by the subtrahend (Le. M).",
      M6800 | M6803}},
    {"BITA",
     {{0, 0x85, 0x95, 0xA5, 0xB5, 0},
      "--**0-",
      "ACCA·M",
      "Performs the logical 'AND' comparison of the contents of ACCA and the contents of M and modifies condition codes accordingly. Neitherthe contents of ACCX or M operands are "
      "affected. (Each bit of the result of the 'AND' would be the logical 'AND' of the corresponding bits of M and ACCA.)",
      M6800 | M6803}},
    {"BITB",
     {{0, 0xC5, 0xD5, 0xE5, 0xF5, 0},
      "--**0-",
      "ACCB·M",
      "Performs the logical 'AND' comparison of the contents of ACCB and the contents of M and modifies condition codes accordingly. Neitherthe contents of ACCX or M operands are "
      "affected. (Each bit of the result of the 'AND' would be the logical 'AND' of the corresponding bits of M and ACCB.)",
      M6800 | M6803}},
    {"BLE",
     {{0, 0, 0, 0, 0, 0x2F},
      "------",
      "Branch if less than or equal to zero - Z=1 or N!=V",
      "Causes a branch if [Z is set] OR [(N is set and V is clear) OR (N is clear and V is set)]. If the BlE instruction is executed immediately after execution of any of the "
      "instructions CSA, CMP, SBA, or SUB, the branch will occur if and only if the two's complement number represented by the "
      "minuend (Le. ACCX) was less then or equal to the two's complement number represented by the subtrahend (Le. M).",
      M6800 | M6803}},
    {"BLS",
     {{0, 0, 0, 0, 0, 0x23},
      "------",
      "Branch if lower or same - C=1 or Z=1",
      "Causes a branch if (C is set) OR (Z is set). If the BLS instruction is executed immediately after execution of any of the instructions CBA, CMP, SBA, or SUB, the branch "
      "will occur if and only if the unsigned binary number represented by the minuend (Le. ACCX) was less than or equal to the "
      "unsigned binary number represented by the subtrahend (Le. M).",
      M6800 | M6803}},
    {"BLT",
     {{0, 0, 0, 0, 0, 0x2D},
      "------",
      "Branch if less than zero - N!=V",
      "Causes a branch if (N is set and V is clear) OR (N is clear and V is set). If the BLT instruction is executed immediately after execution of any of the instructions CBA, "
      "CMP, SBA, or SUB, the branch will occur if and only if the two's complement number represented by the minuend (Le. "
      "ACCX) was less than the two's complement number represented by the subtrahend (Le. M).",
      M6800 | M6803}},
    {"BMI", {{0, 0, 0, 0, 0, 0x2B}, "------", "Branch if minus - N=1", "Tests the state of the N bit and causes a branch if N is set.", M6800 | M6803}},
    {"BNE", {{0, 0, 0, 0, 0, 0x26}, "------", "Branch if not equal - Z=0", "Tests the state of the Z bit and causes a branch if the Z bit is clear.", M6800 | M6803}},
    {"BPL", {{0, 0, 0, 0, 0, 0x2A}, "------", "Branch if plus - N=0", "Tests the state of the N bit and causes a branch if N is clear", M6800 | M6803}},
    {"BRA",
     {{0, 0, 0, 0, 0, 0x20},
      "------",
      "Branch always",
      "Unconditional branch to the address given by the foregoing formula, in which R is the relative address stored as a two's complement number in the second byte of machine "
      "code corresponding to the branch instruction",
      M6800 | M6803}},
    {"BRN", {{0, 0, 0, 0, 0, 0x21}, "------", "Branch never", "Never causes a branch.", M6803}},
    {"BSR",
     {{0, 0, 0, 0, 0, 0x8D},
      "------",
      "Branch to subroutine",
      "The program counteris incremented by 2. The less significant byte ofthe contents of the program counter is pushed into the stack. The stack pointer is then decremented (by "
      "1). The more significant byte of the contents of the program counter is then pushed into the stack. The stack pointer "
      "is again decremented (by 1). A branch then occurs to the location specified by the program.",
      M6800 | M6803}},
    {"BVC", {{0, 0, 0, 0, 0, 0x28}, "------", "Branch if overflow clear - V=0", "Tests the state of the V bit and causes a branch if the V bit is clear.", M6800 | M6803}},
    {"BVS", {{0, 0, 0, 0, 0, 0x29}, "------", "Branch if overflow set - V=1", "Tests the state of the V bit and causes a branch if the V bit is set.", M6800 | M6803}},
    {"CBA",
     {{0x11, 0, 0, 0, 0, 0},
      "--****",
      "ACCA-ACCB",
    ...
    {"CMPA",
     {{0, 0x81, 0x91, 0xA1, 0xB1, 0},
      "--****",
      "ACCA - M",
      "Compares the contents of ACCA and the contents of M and determines the condition codes, which may be used subsequently for controlling conditional branching. Both operands "
      "are unaffected.",
      M6800 | M6803}},
    {"CMPB",
     {{0, 0xC1, 0xD1, 0xE1, 0xF1, 0},
      "--****",
      "ACCB - M",
      "Compares the contents of ACCB and the contents of M and determines the condition codes, which may be used subsequently for controlling conditional branching. Both operands "
      "are unaffected.",
      M6800 | M6803}},
    ...
    {"CPX",
     {{0, 0x8C, 0x9C, 0xAC, 0xBC, 0},
      "--****",
      "X - M:(M+1)",
      "The more significant byte of the contents of the index register is compared with the contents of the byte of memory at the address specified by the program. The less "
      "significant byte of the contents of the index register is compared with the contents of the next byte of memory, at one "
      "plus the address specified by the program. The Z bit is set or reset according to the results of these comparisons, and may be used subsequently for conditional branching. "
    ...
    {"DAA",
     {{0x19, 0, 0, 0, 0, 0},
      "--****",
      "decimal adjust ACCA",
      "Adjusts the contents of the ACCA register after arithmetic operations with binary-coded-decimal (BCD) operands. It ensures proper representation of BCD sums by adjusting "
      "both high and low nibbles, considering the carry bit's state.",
      M6800 | M6803}},
    ...
    {"EORA",
     {{0, 0x88, 0x98, 0xA8, 0xB8, 0},
      "--**0-",
      "ACCA <- ACCA ⊕ M",
      "Perform logical 'EXCLUSIVE OR' between the contents of ACCA and the contents of M, and place the result in ACCA. (Each bit of ACCA afterthe operation will be the logical "
      "'EXCLUSIVE OR' of the corresponding bit of M and ACCA before the operation.)",
      M6800 | M6803}},
    {"EORB",
     {{0, 0xC8, 0xD8, 0xE8, 0xF8, 0},
      "--**0-",
      "ACCB <- ACCB ⊕ M",
      "Perform logical 'EXCLUSIVE OR' between the contents of ACCB and the contents of M, and place the result in ACCB. (Each bit of ACCB afterthe operation will be the logical "
      "'EXCLUSIVE OR' of the corresponding bit of M and ACCB before the operation.)",
      M6800 | M6803}},
    ...
    {"JSR",
     {{0, 0, 0x9D, 0xAD, 0xBD, 0},
      "------",
      "Jump to subroutine",
      "The program counter is incremented by 3 or by 2, depending on the addressing mode, and is then pushed onto the stack, eight bits at a time. The stack pointer points to the "
      "next empty location in the stack. A jump occurs to the instruction stored at the numerical address.",
      M6800 | M6803}},
    ...
    {"LDS",
     {{0, 0x8E, 0x9E, 0xAE, 0xBE, 0},
      "--**0-",
      "SP <- M:(M+1)",
      "Loads the more significant byte of the stack pointer from the byte of memory at the address specified by the program, and loads the less significant byte of the stack "
      "pointer from the next byte of memory, at one plus the address specified by the program.",
      M6800 | M6803}},
    {"LDX",
     {{0, 0xCE, 0xDE, 0xEE, 0xFE, 0},
      "--**0-",
      "X <- M:(M+1)",
      "Loads the more significant byte of the index register from the byte of memory at the address specified by the program, and loads the less significant byte of the index "
      "register from the next byte of memory, at one plus the address specified by the program.",
      M6800 | M6803}},
    ...
    {"ORAA",
     {{0, 0x8A, 0x9A, 0xAA, 0xBA, 0},
      "--**0-",
      "ACCA <- ACCA ∨ M",
      "Perform logical 'OR' between the contents of ACCA and the contents of M and places the result in ACCA. (Each bit of ACCA afterthe operation will be the logical 'OR' of the "
      "corresponding bits of M and of ACCA before the operation).",
      M6800 | M6803}},
    {"ORAB",
     {{0, 0xCA, 0xDA, 0xEA, 0xFA, 0},
      "--**0-",
      "ACCB <- ACCB ∨ M",
      "Perform logical 'OR' between the contents of ACCB and the contents of M and places the result in ACCB. (Each bit of ACCB afterthe operation will be the logical 'OR' of the "
      "corresponding bits of M and of ACCB before the operation).",
      M6800 | M6803}},
    ...
    {"PSHX",
     {{0x3C, 0, 0, 0, 0, 0},
      "------",
      "Push X",
      "The contents of the most significant byte of the X register is stored in the stack at the address contained in the stack pointer. The stack pointer is then decremented. "
      "The same then happens for the least significant byte of X.",
      M6803}},
    ...
    {"PULX",
     {{0x38, 0, 0, 0, 0, 0},
      "------",
      "Pull X",
      "SP is incremented. The data at the address which is contained in the SP is then loaded from the stack to the least significant byte of X register. Then SP is incremented "
      "again, and the data at the address of SP is stored to the most significant byte of the X register.",
      M6803}},
    ...
    {"RTI",
     {{0x3B, 0, 0, 0, 0, 0},
      ...
      "The condition codes, accumulators B and A, the index register, and the program counter, will be restored to a state pulled from the stack. Note that the interrupt mask bit "
      "will be reset if and only ifthe corresponding bit stored in the stack is zero.",
      M6800 | M6803}},
    {"RTS",
     {{0x39, 0, 0, 0, 0, 0},
      "------",
      "Return from subroutine",
      "The stack pointer is incremented (by 1). The contents of the byte of memory, at the address now contained in the stack pointer, are loaded into the 8 bits of highest "
      "significance in the program counter. The stack pointer is again incremented (by 1). The contents of the byte of memory, at "
    ...
    {"STS",
     {{0, 0, 0x9F, 0xAF, 0xBF, 0},
      "--**0-",
      "M:(M+1) <- SP",
      "Stores the more significant byte of the stack pointer in memory at the address specified by the program, and stores the less significant byte of the stack pointer at the "
      "next location in memory, at one plus the address specified by the program.",
      M6800 | M6803}},
    {"STX",
     {{0, 0, 0xDF, 0xEF, 0xFF, 0},
      "--**0-",
      "M:(M+1) <- X",
      "Stores the more significant byte of the index register in memory at the address specified by the program, and stores the less significant byte of the index register at the "
      "next location in memory, at one plus the address specified by the program.",
      M6800 | M6803}},
    ...
    {"SWI",
     {{0x3F, 0, 0, 0, 0, 0},
      "-1----",
      "Software Interrupt",
      "The program counter is incremented (by 1). The program counter, index register, and accumulator A and B, are pushed into the stack. The condition codes register is then "
      "pushed into the stack, with condition codes H, I, N, Z, V, C going respectively into bit positions 5 thru 0, and the top "
      "two bits (in bit positions 7 and 6) are set (to the 1 state). The stack pointer is decremented (by 1) after each byte of data is stored in the stack. The interrupt mask "
      "bit is then set. The program counter is then loaded with the address stored in the software interrupt pointer at memory "
      "locations (n-5) and (n-4), where n is the address corresponding to a high state on all lines of the address bus.",
      M6800 | M6803}},
    ...
    {"TST", {{0, 0, 0, 0x6D, 0x7D, 0}, "--**00", "M - 00", "Set condition codes Nand Z according to the contents of M.", M6800 | M6803}},
    {"TSTA", {{0x4D, 0, 0, 0, 0, 0}, "--**00", "ACCA - 00", "Set condition codes Nand Z according to the contents of ACCA.", M6800 | M6803}},
    {"TSTB", {{0x5D, 0, 0, 0, 0, 0}, "--**00", "ACCB - 00", "Set condition codes Nand Z according to the contents of ACCB.", M6800 | M6803}},
  ...
  static const QMap<QString, Allias> alliasMap = {{"BYTE", {".BYTE", "Allias for .BYTE", M6800 | M6803}},
                                                  ...
                                                  {"BHS", {"BCC", "Alias for BCC. Branch if higher or same", M6803}},
                                                  {"BLO", {"BCS", "Allias for BCS.", M6803}}};

  const QList<QString> M6800Mnemonics =
    {"ZERO", "NOP",     "INVALID", "INVALID", "INVALID", "INVALID", "TAP",  "TPA",     "INX",     "DEX",  "CLV",     "SEV",     "CLC",     "SEC",     "CLI",     "SEI",
     "SBA",  "CBA",     "INVALID", "INVALID", "INVALID", "INVALID", "TAB",  "TBA",     "INVALID", "DAA",  "INVALID", "ABA",     "INVALID", "INVALID", "INVALID", "INVALID",
     "BRA",  "INVALID", "BHI",     "BPL",     "BCC",     "BCS",     "BNE",  "BEQ",     "BVC",     "BVS",  "BPL",     "BMI",     "BGE",     "BLT",     "BGT",     "BLE",
     "TSX",  "INS",     "PULA",    "PULB",    "DES",     "TCS",     "PSHA", "PSHB",    "INVALID", "RTS",  "INVALID", "RTI",     "INVALID", "INVALID", "WAI",     "SWI",
     "NEGA", "INVALID", "INVALID", "COMA",    "LSRA",    "INVALID", "RORA", "ASRA",    "ASLA",    "ROLA", "DECA",    "INVALID", "INCA",    "TSTA",    "INVALID", "CLRA",
     "NEGB", "INVALID", "INVALID", "COMB",    "LSRB",    "INVALID", "RORB", "ASRB",    "ASLB",    "ROLB", "DECB",    "INVALID", "INCB",    "TSTB",    "INVALID", "CLRB",
     "NEG",  "INVALID", "INVALID", "COM",     "LSR",     "INVALID", "ROR",  "ASR",     "ASL",     "ROL",  "DEC",     "INVALID", "INC",     "TST",     "JMP",     "CLR",
     "NEG",  "INVALID", "INVALID", "COM",     "LSR",     "INVALID", "ROR",  "ASR",     "ASL",     "ROL",  "DEC",     "INVALID", "INC",     "TST",     "JMP",     "CLR",
     "SUBA", "CMPA",    "SBCA",    "INVALID", "ANDA",    "BITA",    "LDAA", "INVALID", "EORA",    "ADCA", "ORAA",    "ADDA",    "CPX",     "BSR",     "LDS",     "INVALID",
     "SUBA", "CMPA",    "SBCA",    "INVALID", "ANDA",    "BITA",    "LDAA", "STAA",    "EORA",    "ADCA", "ORAA",    "ADDA",    "CPX",     "INVALID", "LDS",     "STS",
     "SUBA", "CMPA",    "SBCA",    "INVALID", "ANDA",    "BITA",    "LDAA", "STAA",    "EORA",    "ADCA", "ORAA",    "ADDA",    "CPX",     "JSR",     "LDS",     "STS",
     "SUBA", "CMPA",    "SBCA",    "INVALID", "ANDA",    "BITA",    "LDAA", "STAA",    "EORA",    "ADCA", "ORAA",    "ADDA",    "CPX",     "JSR",     "LDS",     "STS",
     "SUBB", "CMPB",    "SBCB",    "INVALID", "ANDB",    "BITB",    "LDAB", "INVALID", "EORB",    "ADCB", "ORAB",    "ADDB",    "INVALID", "INVALID", "LDX",     "INVALID",
     "SUBB", "CMPB",    "SBCB",    "INVALID", "ANDB",    "BITB",    "LDAB", "STAB",    "EORB",    "ADCB", "ORAB",    "ADDB",    "INVALID", "INVALID", "LDX",     "STX",
     "SUBB", "CMPB",    "SBCB",    "INVALID", "ANDB",    "BITB",    "LDAB", "STAB",    "EORB",    "ADCB", "ORAB",    "ADDB",    "INVALID", "INVALID", "LDX",     "STX",
     "SUBB", "CMPB",    "SBCB",    "INVALID", "ANDB",    "BITB",    "LDAB", "STAB",    "EORB",    "ADCB", "ORAB",    "ADDB",    "INVALID", "INVALID", "LDX",     "STX"};
  const QList<QString> M6803Mnemonics =
    {"ZERO", "NOP",     "INVALID", "INVALID", "LSRD",    "ASLD",    "TAP",  "TPA",     "INX",     "DEX",  "CLV",     "SEV",     "CLC",     "SEC",     "CLI",     "SEI",
     "SBA",  "CBA",     "INVALID", "INVALID", "INVALID", "INVALID", "TAB",  "TBA",     "INVALID", "DAA",  "INVALID", "ABA",     "INVALID", "INVALID", "INVALID", "INVALID",
     "BRA",  "BRN",     "BHI",     "BPL",     "BCC",     "BCS",     "BNE",  "BEQ",     "BVC",     "BVS",  "BPL",     "BMI",     "BGE",     "BLT",     "BGT",     "BLE",
     "TSX",  "INS",     "PULA",    "PULB",    "DES",     "TCS",     "PSHA", "PSHB",    "PULX",    "RTS",  "ABX",     "RTI",     "PSHX",    "MUL",     "WAI",     "SWI",
     "NEGA", "INVALID", "INVALID", "COMA",    "LSRA",    "INVALID", "RORA", "ASRA",    "ASLA",    "ROLA", "DECA",    "INVALID", "INCA",    "TSTA",    "INVALID", "CLRA",
     "NEGB", "INVALID", "INVALID", "COMB",    "LSRB",    "INVALID", "RORB", "ASRB",    "ASLB",    "ROLB", "DECB",    "INVALID", "INCB",    "TSTB",    "INVALID", "CLRB",
     "NEG",  "INVALID", "INVALID", "COM",     "LSR",     "INVALID", "ROR",  "ASR",     "ASL",     "ROL",  "DEC",     "INVALID", "INC",     "TST",     "JMP",     "CLR",
     "NEG",  "INVALID", "INVALID", "COM",     "LSR",     "INVALID", "ROR",  "ASR",     "ASL",     "ROL",  "DEC",     "INVALID", "INC",     "TST",     "JMP",     "CLR",
     "SUBA", "CMPA",    "SBCA",    "SUBD",    "ANDA",    "BITA",    "LDAA", "INVALID", "EORA",    "ADCA", "ORAA",    "ADDA",    "CPX",     "BSR",     "LDS",     "INVALID",
     "SUBA", "CMPA",    "SBCA",    "SUBD",    "ANDA",    "BITA",    "LDAA", "STAA",    "EORA",    "ADCA", "ORAA",    "ADDA",    "CPX",     "JSR",     "LDS",     "STS",
     "SUBA", "CMPA",    "SBCA",    "SUBD",    "ANDA",    "BITA",    "LDAA", "STAA",    "EORA",    "ADCA", "ORAA",    "ADDA",    "CPX",     "JSR",     "LDS",     "STS",
     "SUBA", "CMPA",    "SBCA",    "SUBD",    "ANDA",    "BITA",    "LDAA", "STAA",    "EORA",    "ADCA", "ORAA",    "ADDA",    "CPX",     "JSR",     "LDS",     "STS",
     "SUBB", "CMPB",    "SBCB",    "ADDD",    "ANDB",    "BITB",    "LDAB", "INVALID", "EORB",    "ADCB", "ORAB",    "ADDB",    "LDD",     "INVALID", "LDX",     "INVALID",
