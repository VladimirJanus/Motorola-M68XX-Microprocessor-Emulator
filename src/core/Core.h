...
namespace Core {
  ...
  const ProcessorVersion allProcessorVersionsMask = ProcessorVersion(M6800 | M6803);
  ...
  const QMap<AddressingMode, AddressingModeInfo> addressingModes = {
    {AdrMode::INVALID, AddressingModeInfo{0, -1}},
    {AdrMode::INH,     AddressingModeInfo{1, 0} },
    {AdrMode::IMM,     AddressingModeInfo{2, 1} },
    {AdrMode::IMMEXT,  AddressingModeInfo{3, 1} },
    {AdrMode::DIR,     AddressingModeInfo{2, 2} },
    {AdrMode::IND,     AddressingModeInfo{2, 3} },
    {AdrMode::EXT,     AddressingModeInfo{3, 4} },
    {AdrMode::REL,     AddressingModeInfo{2, 5} },
  };
  ...
  static const QList<InstructionInfo> M6800InstructionPage = {{AdrMode::INVALID, 0},
                                                              {AdrMode::INH, 2},
                                                              {AdrMode::INVALID, 0},
                                                              {AdrMode::INVALID, 0},
                                                              {AdrMode::INVALID, 0},
                                                              ...
                                                              {AdrMode::EXT, 5},
                                                              {AdrMode::EXT, 6}};
  static const QList<InstructionInfo> M6803InstructionPage = {{AdrMode::INVALID, 0},
                                                              {AdrMode::INH, 2},
                                                              {AdrMode::INVALID, 0},
                                                              {AdrMode::INVALID, 0},
                                                              {AdrMode::INH, 3},
  ...
  static const MnemonicInfo invalidMnemonic{
    "INVALID", {0, 0, 0, 0, 0, 0},
     "", "", "", 0
  };
  static const QList<MnemonicInfo> mnemonics = {
    ...
    {"CPX",   {0, 0x8C, 0x9C, 0xAC, 0xBC, 0}, "--****", "X - M:(M+1)",                                    "Compares the high byte of index register with memory at specified address, and low byte with memory at address+1. Sets Z flag based on results for conditional branching. N and V flags are affected but not intended for branching.",                                                                                                                                                                                                                                                                  M6800 | M6803},
    ...
    {"SWI",   {0x3F, 0, 0, 0, 0, 0},          "-1----", "Software Interrupt",                             "The program counter increments by 1. The PC, index register, and accumulators A and B are pushed onto the stack. The condition codes register follows, with H, I, N, Z, V, C in bit positions 5-0, while bits 7-6 are set to 1. The stack pointer decrements after each byte is stored. The interrupt mask bit is set. Finally, the PC loads the address from the software interrupt pointer at memory locations (n-5) and (n-4), where n represents the address when all address bus lines are high.", M6800 | M6803},
